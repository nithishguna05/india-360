...
const slides = [
  {
    id: 1,
    title: "India 360",
    subtitle: "Explore India all around",
    media: "/assets/hero/in.mp4",
    poster: "/assets/hero/India-360.jpg",
    topic: "India 360",
    type: "video",
  },
  {
    id: 2,
    title: "Adventure",
    subtitle: "Thrilling mountain & river adventures",
    media: "/assets/hero/av.mp4",
    poster: "/assets/hero/Adventure.jpg",
    topic: "Adventure",
    type: "video",
  },
  {
    id: 3,
    title: "Nature",
    subtitle: "Lush landscapes & scenic beauty",
    media: "/assets/hero/na.mp4",
    poster: "/assets/hero/Nature.jpg",
    topic: "Nature",
    type: "video",
  },
  {
    id: 4,
    title: "Wildlife",
    subtitle: "Meet the wild",
    media: "/assets/hero/wi.mp4",
    poster: "/assets/hero/Wildlife.jpg",
    topic: "Wildlife",
    type: "video",
  },
  {
    id: 5,
    title: "Heritage",
    subtitle: "Ancient monuments & culture",
    media: "/assets/hero/he.mp4",
    poster: "/assets/hero/Heritage.jpg",
    topic: "Heritage",
    type: "video",
  },
  {
    id: 6,
    title: "Spiritual",
    subtitle: "Peaceful spiritual journeys",
    media: "/assets/hero/te.mp4",
    poster: "/assets/hero/Spiritual.jpg",
    topic: "Spiritual",
    type: "video",
  },
];
...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative h-[70vh] md:h-[80vh] overflow-hidden">
      {slides.map((s, i) => (
        ...
        >
          ...
          <div className="absolute inset-0 hero-overlay flex flex-col items-center justify-center px-4 text-center">
            ...
            <p className="mt-2 md:mt-4 max-w-2xl text-white drop-shadow">
              {slides[idx].subtitle}
            </p>

            <section
              className="container mx-auto px-4 mt-6 max-w-5xl"
              data-aos="fade-up"
            >
              <div className="bg-white/20 backdrop-blur-md rounded-lg shadow p-4">
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
                  ...
                  <div className="relative w-full sm:w-40">
                    ...
                    {location && (
                      <div className="absolute bg-white text-black mt-1 w-full rounded shadow-lg max-h-40 overflow-y-auto z-20">
                        {places
                          .filter((p) =>
                            p.toLowerCase().startsWith(location.toLowerCase()),
                          )
                          .map((p, i) => (
                            <div
                              key={i}
                  ...
                  <input
                    type="date"
                    className="w-full sm:w-36 border border-white/40 bg-transparent text-white px-3 py-2 rounded placeholder-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
              ...
              {slides.map((t, i) => (
                <div
                  ...
                  className={`cursor-pointer px-2 md:px-3 transition-all duration-300 ${
                    i === idx
                      ? "bg-yellow-400 text-black rounded-full px-4 py-1"
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/40 p-2 rounded-full text-white z-20"
      >
        <ChevronLeft size={20} />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/40 p-2 rounded-full text-white z-20"
      >
