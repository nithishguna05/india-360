  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="grid md:grid-cols-3 gap-6">
        <img src={p.image} alt={p.title} className="w-full h-80 object-cover rounded col-span-1 md:col-span-2"/>
        <div>
          <h1 className="text-3xl font-bold mb-2">{p.title}</h1>
          <p className="text-gray-500 mb-4">{p.duration} • {p.highlights}</p>
      ...
      <section className="mt-8">
        ...
        <p className="text-gray-600 mt-2">Sample itinerary details go here. Replace with real data.</p>
      </section>
    </div>
  )
}
